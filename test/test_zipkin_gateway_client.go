...
var (
	...
	data     = flag.String("data", "{}", "json format")
	addr     = flag.String("addr", "http://127.0.0.1:80/", "start http format")
	auth     = flag.String("auth", "", "auth header")
)
...
func main() {
	...
	localAddr := "127.0.0.1:9410"
	// create our local service endpoint
	endpoint, err := zipkin.NewEndpoint("my-client", localAddr)
	if err != nil {
